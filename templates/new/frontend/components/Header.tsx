          ...
          <div className="flex items-center pl-0">
            ...
            >
              ...
              <div className="flex flex-col -space-y-1">
                <span className="text-lg sm:text-xl font-bold text-white leading-none">[MY_APP]</span>
                <span className="text-[10px] text-[--header-text-secondary] hidden sm:block">[Tagline]</span>
              </div>
            </Link>
          </div>
          ...
          {!isAuthenticated && (
            <div className="hidden md:flex items-center justify-center flex-1 gap-8">
              ...
              <Link
                href="/features"
                className={classNames(
                  pathname === "/features" ? "text-white" : "text-[--header-text-secondary]",
                  "text-sm font-medium hover:text-white transition-colors"
                )}
              >
                Features
              ...
              <Link
                href="/pricing"
                className={classNames(
                  pathname === "/pricing" ? "text-white" : "text-[--header-text-secondary]",
                  "text-sm font-medium hover:text-white transition-colors"
                )}
              >
                Pricing
        ...
        <div className="md:hidden">
          <div className="space-y-1 px-4 pb-4 pt-2 border-t border-blue-800/30 bg-blue-950/95">
            ...
            <Link
              ...
              onClick={() => setMobileMenuOpen(false)}
              className={classNames(
                pathname === "/features" ? "bg-blue-800/50 text-white" : "text-zinc-300 hover:bg-blue-800/30 hover:text-white",
                "block rounded-md px-3 py-2 text-base font-medium transition-colors"
              )}
            >
              Features
            ...
            <Link
              ...
              onClick={() => setMobileMenuOpen(false)}
              className={classNames(
                pathname === "/pricing" ? "bg-blue-800/50 text-white" : "text-zinc-300 hover:bg-blue-800/30 hover:text-white",
                "block rounded-md px-3 py-2 text-base font-medium transition-colors"
              )}
            >
              Pricing
