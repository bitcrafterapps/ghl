        ...
        return (
          ...
          >
            ...
            <div className={cn(
              ...
              "bg-[#1C1C1C]/80 backdrop-blur-sm border-x border-b-0 border-white/5",
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 text-xs text-gray-500 bg-white/5 rounded">
                  {jobs.length}
                </span>
              </div>
            ...
            {/* Column Body */}
            <div className="min-h-[400px] p-3 space-y-3 bg-[#0a0a0f]/50 border border-white/5 rounded-b-xl">
              {jobs.length === 0 ? (
