...
export function Header({ userProfile, onLogout }: HeaderProps) {
  ...
  return (
    <nav 
      className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl border-b shadow-lg !bg-header"
      style={{
    ...
    >
          ...
          <div className="flex items-center pl-0">
            ...
            >
              ...
              <div className="flex flex-col -space-y-1">
                <span className="text-lg sm:text-xl font-bold text-white leading-none">{"Frnakies"}</span>
                <span className="text-[10px] text-[--header-text-secondary] hidden sm:block">{"Professional Pool Service"}</span>
              </div>
            </Link>
          </div>
      ...
      {!isAuthenticated && mobileMenuOpen && (
        <div className="md:hidden">
          <div 
            className="space-y-1 px-4 pb-4 pt-2 border-t border-white/10 !bg-header"
          >
            <Link
              href="/"
