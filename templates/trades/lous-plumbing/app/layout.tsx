...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Lous Plumbing | Plumbing Services in Rancho Santa Margarita, CA',
    template: '%s | Lous Plumbing',
  },
  description: 'Lous Plumbing provides professional plumbing services in Rancho Santa Margarita, CA. 10+ years experience. Licensed & insured. Call for a free estimate!',
  ...
  authors: [{ name: 'Lous Plumbing' }],
  openGraph: {
    title: 'Lous Plumbing | Plumbing Services',
    description: 'Lous Plumbing provides professional plumbing services in Rancho Santa Margarita, CA. 10+ years experience. Licensed & insured. Call for a free estimate!',
    url: '',
    siteName: 'Lous Plumbing',
    locale: 'en_US',
    type: 'website',
  },
  twitter: {
