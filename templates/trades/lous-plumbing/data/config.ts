...
export const siteConfig = {
  ...
  companyId: (() => { const id = "12"; return !isNaN(parseInt(id)) ? parseInt(id) : null; })(),
  ...
  seo: {
    ...
    metaDescription: "Lous Plumbing provides professional plumbing services in Rancho Santa Margarita, CA. 10+ years experience. Licensed & insured. Call for a free estimate!",
