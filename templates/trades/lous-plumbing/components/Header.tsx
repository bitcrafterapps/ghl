      ...
      <div className="w-full px-4">
        <div className="relative flex h-16 items-center">
          ...
          <div className="flex items-center flex-shrink-0">
            ...
            >
              {siteConfig.branding?.logoUrl && siteConfig.branding.logoUrl !== '' ? (
                 <img 
              ...
              <div className="flex flex-col -space-y-1">
                <span className="text-lg sm:text-xl font-bold text-white leading-none">{siteConfig.company?.name && siteConfig.company.name !== 'Lous Plumbing' ? siteConfig.company.name : 'Company Name'}</span>
