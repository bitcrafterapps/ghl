          ...
          <div className="flex items-center pl-0">
            ...
            >
              ...
              <div className="flex flex-col -space-y-1">
                <span className="text-lg sm:text-xl font-bold text-white leading-none">{"Freds"}</span>
                <span className="text-[10px] text-[--header-text-secondary] hidden sm:block">{"Professional Roofing"}</span>
              </div>
            </Link>
          </div>
