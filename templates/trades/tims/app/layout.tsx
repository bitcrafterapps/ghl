...
export const metadata: Metadata = {
  metadataBase: new URL('https://tims.com' || 'https://example.com'),
  title: {
    default: 'Tims | HVAC Services in Irvine, CA',
    template: '%s | Tims',
  },
  description: 'Tims provides professional hvac services in Irvine, CA. 23+ years experience. Licensed & insured. Call for a free estimate!',
  keywords: 'hvac, Irvine, CA, ac repair, ac installation, heating repair, furnace installation, hvac maintenance, duct cleaning',
  authors: [{ name: 'Tims' }],
  openGraph: {
    title: 'Tims | HVAC Services',
    description: 'Tims provides professional hvac services in Irvine, CA. 23+ years experience. Licensed & insured. Call for a free estimate!',
    url: 'https://tims.com',
    siteName: 'Tims',
    locale: 'en_US',
