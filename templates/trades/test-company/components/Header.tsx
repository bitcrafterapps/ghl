      ...
      <div className="w-full px-4">
        <div className="relative flex h-16 items-center">
          ...
          <div className="flex items-center flex-shrink-0">
            ...
            >
              {siteConfig.branding?.logoUrl && siteConfig.branding.logoUrl !== '/tmp/non-existent-logo.png' ? (
                 <img 
              ...
              <div className="flex flex-col -space-y-1">
                <span className="text-lg sm:text-xl font-bold text-white leading-none">{siteConfig.company?.name && siteConfig.company.name !== 'Test Company' ? siteConfig.company.name : 'Company Name'}</span>
                <span className="text-[10px] text-[--header-text-secondary] hidden sm:block">{siteConfig.branding?.tagline && siteConfig.branding.tagline !== 'Test Tagline' ? siteConfig.branding.tagline : 'Your tagline here'}</span>
              </div>
            </Link>
          </div>
