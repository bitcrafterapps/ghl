...
import { Search, Bell, DumbbellIcon, FileText, LayoutDashboard, Globe } from "lucide-react";
...
export function Header({ userProfile, onLogout }: HeaderProps) {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[--header-bg] backdrop-blur-xl border-b border-[--header-border]">
      <div className="w-full px-4 sm:px-6">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex items-center pl-0">
            ...
            >
              <span className="text-3xl sm:text-5xl">COMPANY_ICON</span>
              <div className="flex flex-col -space-y-1">
                <span className="text-lg sm:text-xl font-bold text-white leading-none">Acme</span>
                <span className="text-[10px] text-[--header-text-secondary] hidden sm:block">COMPANY_TAGLINE</span>
              </div>
            </Link>
          </div>
            ...
            <div className="hidden md:flex items-center justify-center flex-1 gap-6">
              <Link
                ...
                className={classNames(
                  pathname === "/" ? "text-white" : "text-[--header-text-secondary]",
              ...
              <Link
                href="/services"
                className={classNames(
                  pathname?.startsWith("/services") ? "text-white" : "text-[--header-text-secondary]",
                  "text-sm font-medium hover:text-white transition-colors"
                )}
              >
                Services
              ...
              <Link
                href="/gallery"
                className={classNames(
                  pathname === "/gallery" ? "text-white" : "text-[--header-text-secondary]",
                  "text-sm font-medium hover:text-white transition-colors"
                )}
              >
                Gallery
              ...
              <Link
                href="/service-areas"
                className={classNames(
                  pathname === "/service-areas" ? "text-white" : "text-[--header-text-secondary]",
                  "text-sm font-medium hover:text-white transition-colors"
                )}
              >
                Service Areas
              ...
              <Link
                href="/about"
                className={classNames(
                  pathname === "/about" ? "text-white" : "text-[--header-text-secondary]",
                  "text-sm font-medium hover:text-white transition-colors"
                )}
              >
                About
              ...
              <Link
                href="/reviews"
                className={classNames(
                  pathname === "/reviews" ? "text-white" : "text-[--header-text-secondary]",
                  "text-sm font-medium hover:text-white transition-colors"
                )}
              >
                Reviews
              ...
              <Link
                href="/contact"
                className={classNames(
                  pathname === "/contact" ? "text-white" : "text-[--header-text-secondary]",
                  "text-sm font-medium hover:text-white transition-colors"
                )}
              >
                Contact
      ...
      {!isAuthenticated && mobileMenuOpen && (
        <div className="md:hidden">
          <div className="space-y-1 px-4 pb-4 pt-2 border-t border-blue-800/30 bg-blue-950/95">
            <Link
              href="/"
              onClick={() => setMobileMenuOpen(false)}
              className={classNames(
                pathname === "/" ? "bg-blue-800/50 text-white" : "text-zinc-300 hover:bg-blue-800/30 hover:text-white",
            ...
            <Link
              ...
              onClick={() => setMobileMenuOpen(false)}
              className={classNames(
                pathname?.startsWith("/services") ? "bg-blue-800/50 text-white" : "text-zinc-300 hover:bg-blue-800/30 hover:text-white",
                "block rounded-md px-3 py-2 text-base font-medium transition-colors"
              )}
            >
              Services
            ...
            <Link
              ...
              onClick={() => setMobileMenuOpen(false)}
              className={classNames(
                pathname === "/gallery" ? "bg-blue-800/50 text-white" : "text-zinc-300 hover:bg-blue-800/30 hover:text-white",
                "block rounded-md px-3 py-2 text-base font-medium transition-colors"
              )}
            >
              Gallery
            ...
            <Link
              ...
              onClick={() => setMobileMenuOpen(false)}
              className={classNames(
                pathname === "/service-areas" ? "bg-blue-800/50 text-white" : "text-zinc-300 hover:bg-blue-800/30 hover:text-white",
                "block rounded-md px-3 py-2 text-base font-medium transition-colors"
              )}
            >
              Service Areas
            ...
            <Link
              ...
              onClick={() => setMobileMenuOpen(false)}
              className={classNames(
                pathname === "/about" ? "bg-blue-800/50 text-white" : "text-zinc-300 hover:bg-blue-800/30 hover:text-white",
                "block rounded-md px-3 py-2 text-base font-medium transition-colors"
              )}
            >
              About
            ...
            <Link
              ...
              onClick={() => setMobileMenuOpen(false)}
              className={classNames(
                pathname === "/reviews" ? "bg-blue-800/50 text-white" : "text-zinc-300 hover:bg-blue-800/30 hover:text-white",
                "block rounded-md px-3 py-2 text-base font-medium transition-colors"
              )}
            >
              Reviews
            ...
            <Link
              ...
              onClick={() => setMobileMenuOpen(false)}
              className={classNames(
                pathname === "/contact" ? "bg-blue-800/50 text-white" : "text-zinc-300 hover:bg-blue-800/30 hover:text-white",
                "block rounded-md px-3 py-2 text-base font-medium transition-colors"
              )}
            >
              Contact
