    ...
    <footer className="py-16 bg-zinc-950 border-t border-zinc-900">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">[MY_APP]</span>
            </Link>
        ...
        <div className="border-t border-zinc-900 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-zinc-500 text-sm">© 2026 [MY_APP]. All rights reserved. <span className="text-zinc-600">v1.00.00</span></p>
