...
export function Header({ userProfile, onLogout }: HeaderProps) {
  ...
  return (
    <nav 
      className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl border-b shadow-lg bg-transparent"
      style={{
          ...
          <div className="flex items-center pl-0">
            ...
            >
              ...
              <div className="flex flex-col -space-y-1">
                <span className="text-lg sm:text-xl font-bold text-white leading-none">{"Sues"}</span>
                <span className="text-[10px] text-[--header-text-secondary] hidden sm:block">{"Professional HVAC"}</span>
              </div>
            </Link>
          </div>
