...
export const metadata: Metadata = {
  metadataBase: new URL('https://sues.com' || 'https://example.com'),
  title: {
    default: 'Sues | HVAC Services in IRvine, CA',
    template: '%s | Sues',
  },
  description: 'Sues provides professional hvac services in IRvine, CA. 2+ years experience. Licensed & insured. Call for a free estimate!',
  keywords: 'hvac, IRvine, CA, ac repair, ac installation, heating repair, furnace installation, hvac maintenance, duct cleaning',
  authors: [{ name: 'Sues' }],
  openGraph: {
    title: 'Sues | HVAC Services',
    description: 'Sues provides professional hvac services in IRvine, CA. 2+ years experience. Licensed & insured. Call for a free estimate!',
    url: 'https://sues.com',
    siteName: 'Sues',
    locale: 'en_US',
