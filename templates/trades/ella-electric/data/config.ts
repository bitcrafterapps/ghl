...
export const siteConfig = {
  ...
  seo: {
    ...
    metaDescription: "Ella Electric provides professional electrical services in RSM, CA. 12+ years experience. Licensed & insured. Call for a free estimate!",
    metaKeywords: "electrical, RSM, CA, electrical repairs, panel upgrades, lighting installation, outlet & switch installation, ceiling fan installation, electrical inspections",
  },

  // Site URL
  siteUrl: "https://ella-electric.com",
