...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Dr Bobbys Electric | Plumbing Services in Rancho Santa Margarita, CA',
    template: '%s | Dr Bobbys Electric',
  },
  description: 'Dr Bobbys Electric provides professional plumbing services in Rancho Santa Margarita, CA. 10+ years experience. Licensed & insured. Call for a free estimate!',
  ...
  authors: [{ name: 'Dr Bobbys Electric' }],
  openGraph: {
    title: 'Dr Bobbys Electric | Plumbing Services',
    description: 'Dr Bobbys Electric provides professional plumbing services in Rancho Santa Margarita, CA. 10+ years experience. Licensed & insured. Call for a free estimate!',
    url: '',
    siteName: 'Dr Bobbys Electric',
    locale: 'en_US',
    type: 'website',
  },
  twitter: {
