...
export const siteConfig = {
  ...
  companyId: (() => { const id = "6"; return !isNaN(parseInt(id)) ? parseInt(id) : null; })(),
  ...
  seo: {
    ...
    metaDescription: "Erin Air provides professional plumbing services in RSM, CA. 12+ years experience. Licensed & insured. Call for a free estimate!",
    metaKeywords: "plumbing, RSM, CA, drain cleaning, water heater repair, water heater installation, leak detection, pipe repair, sewer line services",
  },

  // Site URL
  siteUrl: "https://erin-air.com",
