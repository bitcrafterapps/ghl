...
export const metadata: Metadata = {
  metadataBase: new URL('https://gidgetswidgets.com' || 'https://example.com'),
  title: {
    default: 'GidgetsWidgets | Electrical Services in Irvine, CA',
    template: '%s | GidgetsWidgets',
  },
  description: 'GidgetsWidgets provides professional electrical services in Irvine, CA. 12+ years experience. Licensed & insured. Call for a free estimate!',
  ...
  authors: [{ name: 'GidgetsWidgets' }],
  openGraph: {
    title: 'GidgetsWidgets | Electrical Services',
    description: 'GidgetsWidgets provides professional electrical services in Irvine, CA. 12+ years experience. Licensed & insured. Call for a free estimate!',
    url: 'https://gidgetswidgets.com',
    siteName: 'GidgetsWidgets',
    locale: 'en_US',
    type: 'website',
  },
  twitter: {
