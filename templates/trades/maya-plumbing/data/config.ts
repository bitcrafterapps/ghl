...
export const siteConfig = {
  ...
  // Service Area
  serviceArea: {
    areas: "Ireivne".split(",").map((s: string) => s.trim()),
    radius: "30",
    primaryCity: "Ireivne",
  },
  ...
  seo: {
    ...
    metaDescription: "Maya Plumbing provides professional hvac services in Ireivne, CA. 12+ years experience. Licensed & insured. Call for a free estimate!",
    metaKeywords: "hvac, Ireivne, CA, ac repair, ac installation, heating repair, furnace installation, hvac maintenance, duct cleaning",
  },

  // Site URL
  siteUrl: "https://maya-plumbing.com",
