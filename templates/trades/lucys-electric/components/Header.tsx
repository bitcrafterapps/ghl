          ...
          <div className="flex items-center flex-shrink-0">
            ...
            >
              ...
              <div className="flex flex-col -space-y-1">
                <span className="text-lg sm:text-xl font-bold text-white leading-none">{siteConfig.company?.name && siteConfig.company.name !== 'Lucys Electric' ? siteConfig.company.name : 'Company Name'}</span>
                <span className="text-[10px] text-[--header-text-secondary] hidden sm:block">{siteConfig.branding?.tagline && siteConfig.branding.tagline !== 'We keep you wired' ? siteConfig.branding.tagline : 'Your tagline here'}</span>
              </div>
            </Link>
          </div>
