            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                {contact.contactCompanyName && (
                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">{contact.contactCompanyName}</p>
                )}
              </div>
            </div>
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            {/* Contact Card */}
            <div className="bg-white/50 dark:bg-[#1C1C1C]/80 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-white/5 p-6 space-y-5">
              <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Contact Info</h3>
                ...
                {contact.email && (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">{contact.email}</p>
                    </div>
                  </a>
                )}
                ...
                {contact.phone && (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-900 dark:text-white group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors">{contact.phone}</p>
                    </div>
                  </a>
                )}
                ...
                {contact.contactCompanyName && (
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-900 dark:text-white">{contact.contactCompanyName}</p>
            ...
            <div className="bg-white/50 dark:bg-[#1C1C1C]/80 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-white/5 p-6 space-y-4">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-900 dark:text-white">{SOURCE_LABELS[contact.source]}</span>
                </div>
                <div className="flex justify-between">
            ...
            <div className="bg-white/50 dark:bg-[#1C1C1C]/80 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-white/5 p-6 space-y-3">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <span className="text-sm text-gray-900 dark:text-white">View Jobs</span>
                </Link>
                <Link
                ...
                >
                  ...
                  <span className="text-sm text-gray-900 dark:text-white">Create Job</span>
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white/50 dark:bg-[#1C1C1C]/80 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-white/5 overflow-hidden">
              <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-white/5">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-blue-600 dark:text-blue-400 bg-blue-500/10 hover:bg-blue-500/20 rounded-lg transition-colors"
                >
                ...
                <div className="px-6 py-4 bg-gray-50 dark:bg-[#0a0a0f]/50 border-b border-gray-200 dark:border-white/5">
                  <div className="space-y-4">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 bg-white dark:bg-[#1C1C1C] border border-gray-200 dark:border-white/10 rounded-lg text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                    />
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full px-4 py-2 bg-white dark:bg-[#1C1C1C] border border-gray-200 dark:border-white/10 rounded-lg text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 resize-none"
                    />
            ...
            {/* Notes */}
            {contact.notes && (
              <div className="mt-6 bg-white/50 dark:bg-[#1C1C1C]/80 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-white/5 p-6">
