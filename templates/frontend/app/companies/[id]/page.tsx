      ...
      <div className="max-w-4xl mx-auto py-8 px-4">
        ...
        {(activeTab === 'basic' || isNewCompany) && (
          <form onSubmit={handleSubmit}>
            ...
            {/* Address Section - shown for new companies */}
            {isNewCompany && (
              <div className="p-6 rounded-2xl bg-white dark:bg-zinc-900/50 border border-gray-200 dark:border-zinc-800 mt-6">
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
            ...
            {/* Contact Section - shown for new companies */}
            {isNewCompany && (
              <div className="p-6 rounded-2xl bg-white dark:bg-zinc-900/50 border border-gray-200 dark:border-zinc-800 mt-6">
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
