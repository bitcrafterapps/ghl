...
import { UserRole, ThemeType } from '../../types/user.types';
...
describe('UserService', () => {
  ...
  describe('createUser', () => {
    ...
    it('should create a user successfully', async () => {
      ...
      const mockUser = { ...mockUsers[0], password: 'hashed_password123' };
    ...
    it('should create a user with default roles when roles are not provided', async () => {
      // Mock the database insert and returning methods
      const mockUser = { 
        ...mockUsers[0], 
        password: 'hashed_password123',
    ...
    it('should handle error during activity logging', async () => {
      // Mock the database insert and returning methods
      const mockUser = { ...mockUsers[0], password: 'hashed_password123' };
      db.insert.mockReturnValue({
        values: jest.fn().mockReturnThis(),
      ...
      (ActivityService.logActivity as jest.Mock).mockImplementationOnce(() => {
    ...
    it('should create a user and associate with company if companyId is provided', async () => {
      // Mock the database insert and returning methods
      const mockUser = { ...mockUsers[0], password: 'hashed_password123' };
      db.insert.mockReturnValue({
        values: jest.fn().mockReturnThis(),
    ...
    it('should create a user with default values for optional fields', async () => {
      // Mock the database insert and returning methods
      const mockUser = { 
        id: 1,
        email: 'test@example.com',
  ...
  describe('login', () => {
    ...
    it('should handle error during login process', async () => {
      ...
      // Assertions
      await expect(UserService.login(loginData)).rejects.toThrow('Database connection error');
    });

    it('should handle case when user has no password set', async () => {
      // Mock the database select method to return a user without password
      const userWithoutPassword = { ...mockUsers[0], password: null };
      db.select.mockReturnValue({
        from: jest.fn().mockReturnThis(),
  ...
  describe('getUsers', () => {
    ...
    it('should handle error during getUsers process', async () => {
      // Mock the database select method to throw an error
      ...
      // Assertions
      await expect(UserService.getUsers()).rejects.toThrow('Database connection error');
    });
  });
  ...
  describe('getUserById', () => {
    ...
    it('should handle error during getUserById process', async () => {
      // Mock the database select method to throw an error
      db.select.mockReturnValue({
        from: jest.fn().mockReturnThis(),
        where: jest.fn().mockImplementation(() => {
    ...
    it('should handle user with no roles or theme', async () => {
      // Mock the database select method
      const mockUserNoRolesOrTheme = { 
        ...mockUsers[0],
        roles: null,
        theme: null
      };
      ...
      expect(result?.roles).toEqual(['User']); // Should default to ['User']
      expect(result?.theme).toEqual('system'); // Should default to 'system'
    });
  });
  ...
  describe('updateUser', () => {
    ...
    it('should throw an error when email is already taken', async () => {
      ...
      const existingUser = { ...mockUsers[1] }; // Different user with the same email
      db.select.mockReturnValue({
        from: jest.fn().mockReturnThis(),
      ...
      // Assertions
      await expect(UserService.updateUser(1, userData)).rejects.toThrow('Email is already taken');
    ...
    it('should handle phoneNumber field correctly when empty string is provided', async () => {
      // Mock the database select method to check if email exists
      db.select.mockReturnValue({
        from: jest.fn().mockReturnThis(),
        where: jest.fn().mockResolvedValue([]),
    ...
    it('should update user company association when companyId is provided', async () => {
      // Mock the database select method to check if email exists
      db.select.mockReturnValue({
        from: jest.fn().mockReturnThis(),
        where: jest.fn().mockResolvedValue([]),
    ...
    it('should remove user company association when companyId is null', async () => {
      // Mock the database select method to check if email exists
      db.select.mockReturnValue({
        from: jest.fn().mockReturnThis(),
        where: jest.fn().mockResolvedValue([]),
    ...
    it('should update all user fields correctly', async () => {
      // Mock the database select method to check if email exists
      db.select.mockReturnValue({
        from: jest.fn().mockReturnThis(),
        where: jest.fn().mockResolvedValue([]),
    ...
    it('should handle error during activity logging in updateUser', async () => {
      // Mock the database select method to check if email exists
      db.select.mockReturnValue({
        from: jest.fn().mockReturnThis(),
        where: jest.fn().mockResolvedValue([]),
      ...
      try {
        ...
        await expect(UserService.updateUser(1, userData)).rejects.toThrow('Activity logging failed');
    ...
    it('should handle null values for user fields', async () => {
      // Mock the database select method to check if email exists
      db.select.mockReturnValue({
        from: jest.fn().mockReturnThis(),
        where: jest.fn().mockResolvedValue([]),
  ...
  describe('deleteUser', () => {
    ...
    it('should handle error during activity logging in deleteUser', async () => {
      // Mock the database operations
      db.select.mockReturnValue({
        from: jest.fn().mockReturnThis(),
        where: jest.fn().mockResolvedValue([mockUsers[0]]),
      ...
      try {
        ...
        await expect(UserService.deleteUser(1)).rejects.toThrow('Activity logging failed');
  ...
  describe('getPendingUsers', () => {
    ...
    it('should handle database error when fetching pending users', async () => {
      // Mock the database operations to throw an error
      db.select.mockImplementation(() => {
        throw new Error('Database error');
      });
      
      await expect(UserService.getPendingUsers()).rejects.toThrow('Database error');
    });

    it('should handle empty roles in pending users', async () => {
      const pendingUsers = [
        {
          id: 3,
          email: 'pending@example.com',
